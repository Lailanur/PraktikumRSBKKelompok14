<%-- 
    Document   : profile
    Created on : Nov 11, 2019, 6:49:10 AM
    Author     : Amara Ranindhita
--%>
...
<style>
    body, html {
        background-image: url(img/kel14.jpg);
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul class="nav navbar-nav navbar-right">              
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Kelompok 14 <span class="caret"></span></a>
...
<div class="container col-lg-4 col-md-4 col-sm-4 col-xs-4">              
    ...
    <div class="panel-body text-center">   
        ...
        <br>
        <img src="img/anggota.jpg"style="width:200px;border-radius:50px;">
        <br><br>
        <h3>Amara Ranindhita  &  Laila Nur Aini </h3>
        <h4>21120116120016    &  21120116120029</h4>        
    </div>                
    </div>
</div>
<div class="container col-lg-4 col-md-4 col-sm-4 col-xs-4"></div>
