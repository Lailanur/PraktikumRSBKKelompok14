<%-- 
    Document   : home
    Created on : Oct 24, 2019, 10:37:24 AM
    Author     : Lenovo
--%>
...
<style>
    body, html {
        ...
        th {
        background-color: rgb(73, 90, 184);
        text-align: center;
        }
        td {
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul class="nav navbar-nav navbar-right">              
          <li class="dropdown">
            <a href="profile.jsp" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Kelompok 14 <span class="caret"></span></a>
...
<div class="container col-lg-12 col-md-12 col-sm-12 col-xs-12">          
    ...
    <div class="panel-heading">Isian Identitas Mahasiswa</div>
